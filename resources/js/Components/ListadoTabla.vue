    ...
    <div class="p-4 flex">
        <div class="p-1 rounded-lg">
            <div class="relative bg-inherit">
                <input type="text" id="buscar" name="buscar" v-model="buscar"  class="peer bg-transparent h-10 w-72 rounded-lg text-gray-200 placeholder-transparent ring-2 px-2 ring-gray-500 focus:ring-sky-600 focus:outline-none focus:border-rose-600" placeholder="Buscar aqui"/>
    ...
    <div class="px-3 py-4 flex justify-center">
        <table class="w-full text-md bg-white shadow-md rounded mb-4">
            <tbody>
                ...
                <tr v-for="digesto in digestos.data" :key="digesto.id" class="border-b hover:bg-orange-100 bg-gray-100 text-sm">
                    <td class="p-3 px-5">
                        {{ digesto.numero }}
                    </td>
                    <td class="p-3 px-5">
